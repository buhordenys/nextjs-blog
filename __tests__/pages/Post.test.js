...
describe('test page/posts', () => {
    ...
    it('check initial props', async () => {
        ...
        expect(props).toMatchObject({
            postDate: {
                id: 'ssg-ssr',
                contentHtml: '<p>We recommend using <strong>Static Generation</strong> (with and without data) whenever possible because your page can be built once and served by CDN, which makes it much faster than having a server render the page on every request.' +
                    '</p>\n' +
